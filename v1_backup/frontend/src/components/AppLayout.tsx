...
import { Layout, Menu, Badge, Popover, Avatar, Dropdown, Button } from 'antd';
import {
  DashboardOutlined, FileTextOutlined, AuditOutlined, CheckCircleOutlined,
  CloseCircleOutlined, HourglassOutlined, SettingOutlined, TeamOutlined,
...
export default function AppLayout() {
  ...
  const menuItems = [
    ...
    {
      key: 'approvals', icon: <AuditOutlined />, label: '簽核中心',
      children: [
        { key: '/approvals/pending', icon: <HourglassOutlined />, label: '待我簽核' },
        { key: '/approvals/in-progress', icon: <AuditOutlined />, label: '我的簽核中' },
        { key: '/approvals/completed', icon: <CheckCircleOutlined />, label: '已完成' },
        { key: '/approvals/rejected', icon: <CloseCircleOutlined />, label: '已退回' },
      ],
    },
    ...(user?.role === 'admin' ? [
      {
        ...
        children: [
          { key: '/settings/workflows', icon: <SettingOutlined />, label: '流程範本' },
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Sider collapsible collapsed={collapsed} onCollapse={setCollapsed} theme="dark">
        ...
        <Menu
          ...
          defaultOpenKeys={['approvals', 'admin']}
          items={menuItems}
